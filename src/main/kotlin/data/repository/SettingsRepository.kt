...
import data.GenerateFileComponent
...
class SettingsRepository @Inject constructor(private val project: Project) {
    ...
    fun update(settings: Settings) = GenerateFileComponent.getInstance(project).run {
    ...
    private fun loadSettings() = GenerateFileComponent.getInstance(project).settings
}
